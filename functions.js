        ...
        g.selectAll('path.state')
          ...
          .attr('fill', function (d) {
            ...
            if (value >= 51 && value <= 75) {
              ...
              return '#1EC77626'; // Default color for values below 51
            }
      ...
      datasets: [
        {
          ...
          borderColor: '#516381',
          backgroundColor: 'rgba(81, 99, 129, 0.07)',
          fill: true,
          tension: 0.5,
          borderWidth: 2,
          pointRadius: 0,
        ...
        },
        {
          ...
          data: [], // Will be populated with real data
          borderColor: '#B21FC8',
          backgroundColor: 'rgba(178, 31, 200, 0.07)',
          fill: true,
          tension: 0.5,
          borderWidth: 2,
          pointRadius: 0,
...
async function calculateOperatingCosts(vehicleClass) {
  ...
  jQuery('.operating-costs-card-header').text(
...
async function mapChart(states) {
  ...
  let ev = $('#evSelect').val() || 'Ford F-150 Lightning 4WD';
  let gas = $('#gasSelect').val() || 'Ford F-150 2WD';
  let milesRange = $('#milesRange').val() || 29000;
